...
namespace WAECBanjulAppGUI
{
    public partial class mdiParent : Form
    {
        ...
        private void g5ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmNatG5 frm = new frmNatG5();
            frm.MdiParent = this;
            frm.Show();
        }

        private void wASSCEPrivateCandidatesToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void prePrintObjectiveAnswerSheetsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ShowPrePrintObjForm();
        }
        ...
        private bool ShowPrePrintObjForm()
        {
            ...
            {
                MessageBox.Show($"There was an error loading form. Please report it to your IT support. {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            return false;
        }

        private void absenteeFormToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var absenteeForm = new NatAbsentee();
            absenteeForm.MdiParent = this;
            absenteeForm.Show();
        }
