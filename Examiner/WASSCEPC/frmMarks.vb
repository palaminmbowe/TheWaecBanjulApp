...
Public Class frmMarks
    ...
    Sub AddRecord()
        Try
            ...
            db.cmd.CommandText = "Insert Into TassMarks (ExamYear, CentNo, IndexNo,SubjCode, Mark,ExaminerNo,ModiDate) Values  (" & _
                "'" & ExamYear & "', '" & Strings.Left(cmbCenter.Text, 7) & "', '" & cmbIndex.Text & _
    ...
    Sub getcent()
        Try
            ...
            db.cmd.CommandText = "select Distinct ExpandedEntry.CentNo, Wacenters.Venue from ExpandedEntry " & _
            ...
            While (db.dr.Read())
                cmbCenter.Items.Add(db.dr("CentNo") & " - " & db.dr("Venue"))
            End While
    ...
    Sub Countmarksoustanding()
        Try
            ...
            db.cmd.CommandText = "select count (*) from ExpandedEntry where ExaminerNo=('" & curuser & "') and CentNo='" & Strings.Left(cmbCenter.Text, 7) & "'and SubjCode='" & Strings.Left(CmbSubject.Text, 6) & "' and Flag='" & Flag & "' "
    ...
    Sub UpdateExpandedRecord()
        Try
            ...
            db.cmd.CommandText = "UPDATE ExpandedEntry SET Flag='" + txtMark.Text + "'" _
                  & " WHERE ((ExamYear = '" & ExamYear & "') and (CentNo='" + Strings.Left(cmbCenter.Text, 7) + "') and (IndexNo='" + cmbIndex.Text + "') and (SubjCode='" + Strings.Left(CmbSubject.Text, 6) + "') and ExaminerNo=('" & curuser & "'))"
