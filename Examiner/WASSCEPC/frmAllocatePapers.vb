...
Public Class frmAllocatePapers
    ...
    Private Sub frmAllocatePapers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ExamYear = MDIParent1.CurrentExamYear
        GetExaminer()
        getCent()
        'getPapers()
    End Sub
    ...
    Sub getCent()
        Try
            ...
            db.cmd.CommandText = "SELECT CentNo, Venue FROM wacenters ORDER BY Centno"

            db.dr = db.cmd.ExecuteReader()
            While (db.dr.Read())
                cmbCenter.Items.Add(String.Concat(db.dr("CentNo"), " - ", db.dr("Venue")))
            End While
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAllocate.Click
        ...
        If MessageBox.Show( _
            ...
            vbTab & "Start: " & cbStart.Text & vbTab & "Stop: " & cbStop.Text & vbNewLine & vbNewLine & _
            "to " & Strings.Right(CmbExaminerno.SelectedItem, 16) & vbNewLine & vbNewLine & _
