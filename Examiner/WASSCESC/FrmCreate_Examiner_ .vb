...
Public Class FrmCreate_Examiner_
    ...
    Dim scBottomSizeOriginal As Drawing.Size = New Size(935, 535)
    Dim formSizeOriginal As Drawing.Size = New Size(955, 675)

    Dim scBottomSizeHalfed As Drawing.Size = New Size(935, 375)
    Dim formSizeHalfed As Drawing.Size = New Size(956, 515)
    ...
    Private Sub btnAddDetails_Click(sender As Object, e As EventArgs) Handles btnAddDetails.Click
        If SplitContainerTop.Panel2Collapsed = True Then
            'collapsed, uncollapsed

            SplitContainerBody.Size = scBottomSizeOriginal
            Me.Size = formSizeOriginal
            SplitContainerTop.Panel2Collapsed = False
            btnAddDetails.Text = "Hide Details"
        Else
            'reduce heights
            SplitContainerBody.Size = scBottomSizeHalfed
            Me.Size = formSizeHalfed
            SplitContainerTop.Panel2Collapsed = True
            btnAddDetails.Text = "Show Details"
        End If
    End Sub

    Private Sub txtTadExaminerNo_TextChanged(sender As Object, e As EventArgs) Handles txtTadExaminerNo.TextChanged
        txtPassword.Text = txtTadExaminerNo.Text
        txtCPassword.Text = txtTadExaminerNo.Text
    End Sub

    Private Sub inputTextBox_TextChanged(sender As Object, e As EventArgs) Handles txtlname.TextChanged, txtoname.TextChanged, txtoccup.TextChanged, txtmsubj.TextChanged, txtfname.TextChanged
        Dim sourceTextBox As TextBox = sender

        sourceTextBox.Text = sourceTextBox.Text.ToUpper()
        sourceTextBox.Select(sourceTextBox.Text.Length, 1)
    End Sub

    Private Sub TimerControls_Tick(sender As Object, e As EventArgs) Handles TimerControls.Tick
    ...
    Private Sub CboSubjCode_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CboSubjCode.SelectedIndexChanged
        ...
        Try
            ...
            txtTadExaminerNo.Text = CboSubjCode.Text.Substring(0, 4)

            txtTadExaminerNo.Select(txtTadExaminerNo.Text.Length, 1)
        Catch ex As Exception
