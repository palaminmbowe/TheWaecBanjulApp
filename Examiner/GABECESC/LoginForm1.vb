...
Public Class LoginForm1
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        ...
        Try
            'gcon.Open()
            db.con.Open()
            db.cmd.CommandText = "select MyUsers.CUserId, MyUsers.CPassword, MyUsers.UserLevel, MyUsers.ExaminerNo, ExamBiodetails.TadExaminerNo from MyUsers INNER JOIN ExamBiodetails ON MyUsers.ExaminerNo = ExamBiodetails.ExaminerNo where CUserId = '" & UsernameTextBox.Text & "' AND CPassword='" & PasswordTextBox.Text & "'"
            ...
            If db.dr.Read Then
                ...
                TadExaminerNo = db.dr("TadExaminerNo")
        ...
        'get tad examiner no TadExaminerNo = db.dr("TadExaminerNo")
