...
Public Class frmMarksEnter
    ...
    Private Sub ViewCandidates_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        da = New OleDb.OleDbDataAdapter("select ExamYear,CentNo,IndexNo,SubjCode,Flag as Mark from ExpandedEntry where Flag not Like ('" & Flag & "%') order by IndexNo", con)
    ...
    Sub getindexes()
        ...
        Else
            ...
            cmd.CommandText = "select * from ExpandedEntry where ExamYear Like ('" & ExamYear & "%')and CentNo Like ('" & cmbcenter.Text & "%') and SubjCode Like ('" & cmbSubject.Text & "%') and Flag not Like ('" & Flag & "%')"
            cmd.Connection = gcon
    ...
    Private Sub cmbcenter_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbcenter.SelectedIndexChanged
        ...
        da = New OleDb.OleDbDataAdapter("select ExamYear,CentNo,IndexNo,SubjCode,Flag as Mark from ExpandedEntry where CentNo Like ('" & cmbcenter.Text & "%') and Flag not Like ('" & Flag & "%') order by IndexNo", con)
    ...
    Private Sub cmbindex_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbindex.SelectedIndexChanged
        ...
        da = New OleDb.OleDbDataAdapter("select ExamYear,CentNo,IndexNo,SubjCode,Flag as Mark from ExpandedEntry where CentNo Like ('" & cmbcenter.Text & "%') and SubjCode Like ('" & cmbSubject.Text & "%') and IndexNo Like ('" & cmbindex.Text & "%') and Flag not Like ('" & Flag & "%')  order by IndexNo", con)
    ...
    Private Sub cmbSubject_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbSubject.SelectedIndexChanged
        ...
        da = New OleDb.OleDbDataAdapter("select ExamYear,CentNo,IndexNo,SubjCode,Flag as Mark from ExpandedEntry where CentNo Like ('" & cmbcenter.Text & "%') and SubjCode Like ('" & cmbSubject.Text & "%') and Flag not Like ('" & Flag & "%')  order by IndexNo", con)
