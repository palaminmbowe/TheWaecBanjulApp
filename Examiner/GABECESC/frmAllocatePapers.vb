...
Public Class frmAllocatePapers
    ...
    Sub GetExaminer()
        ...
        Try
            ...
            While db.dr.Read()
                ...
                CmbExaminerno.Items.Add(db.dr("ExaminerNo") & " - " & db.dr("FirstName") & Space(1) & db.dr("SurName") & " - " & db.dr("ExaminerNo"))
            End While
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAllocate.Click
        ...
        If MessageBox.Show(
            "About to start allocation:" & vbNewLine & "" &
            vbTab & "Start: " & cbStart.Text & vbTab & "Stop: " & cbStop.Text & vbNewLine & vbNewLine &
            "to " & Strings.Right(CmbExaminerno.SelectedItem, 16) & vbNewLine & vbNewLine &
            "Do you want to continue with the allocation?", "Please confirm", MessageBoxButtons.YesNo,
            ...
            Try
                ...
                ExamYear = Now.Year()
                db.cmd.CommandText = "select * from Cand_Subjects where ('" & subj &
                    "' in (Sub1,Sub2,Sub3,Sub4,Sub5,Sub6,Sub7,Sub8,Sub9)) and (CentNo = '" & Strings.Left(cmbCenter.SelectedItem, 5) & "') AND " &
                ...
                While db.dr.Read()
                    ...
                    If ((db.dr("IndexNo") >= cbStart.Text) And (db.dr("IndexNo") <= cbStop.Text)) Then
                        ...
                        Try
                            ...
                            db.cmd1.CommandText = "select * from Wapapers where PaperCode = '" & Strings.Left(CmbSubject.Text, 6) & "'"

                            db.dr1 = db.cmd1.ExecuteReader()

                            alot = 0
                            While (db.dr1.Read())
                                PaperCode = (db.dr1("PaperCode"))
                                PaperType = (db.dr1("PaperType"))
                                Dim eng As String
                                Dim eng2 As String
                                ...
                                If ((Strings.Mid(PaperCode, 5, 1) <> "1")) Then
                                    alot += 1
                                    currentindex = index
                                    ...
                                    Try
                                        ...
                                        Dim sqlStatement As String = "Insert into ExpandedEntry(ExamYear,CentNo,IndexNo,SubjCode,ExaminerNo)" _
                                            & " values" _
                                            & "('" & ExamYear & "','" & centno & "','" & db.dr("IndexNo") & "','" & db.dr1("PaperCode") & "','" &
    ...
    Sub getthenumbers()
        ...
        Try
            ...
            db.cmd.CommandText = "select Distinct IndexNo from Cand_Subjects where('" & subjcode & _
                "' in (Sub1,Sub2,Sub3,Sub4,Sub5,Sub6,Sub7,Sub8,Sub9)) AND (CentNo='" & Strings.Left(cmbCenter.Text, 5) & "')"
