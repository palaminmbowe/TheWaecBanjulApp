...
Public Class crpWassceConfirmation
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crpWassceConfirmation.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NatCandidateEntry.crpWassceConfirmation.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WASSCE_Cente() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrpWassceConfirmation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpWassceConfirmation = New crpWassceConfirmation()
        rpt.Site = Me.Site
        Return rpt
    End Function
