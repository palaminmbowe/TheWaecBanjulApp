...
Public Class rptGabeceConfirmation3
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGabeceConfirmation3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GABECE_NAT.rptGabeceConfirmation3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Centre_Number() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptGabeceConfirmation3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGabeceConfirmation3 = New rptGabeceConfirmation3()
        rpt.Site = Me.Site
        Return rpt
    End Function
