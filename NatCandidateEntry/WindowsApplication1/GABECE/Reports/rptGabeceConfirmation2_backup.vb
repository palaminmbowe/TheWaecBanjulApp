...
Public Class rptGabeceConfirmation2_backup
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGabeceConfirmation2_backup.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GABECE_NAT.rptGabeceConfirmation2_backup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGabeceConfirmation2_backup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGabeceConfirmation2_backup = New rptGabeceConfirmation2_backup()
        rpt.Site = Me.Site
        Return rpt
    End Function
