...
Public Class frmNatCentreRemove
    ...
    Private Function DeleteCentre() As Boolean
        ...
        Dim sourceTable As String = "NatAdmin"

        Try
            db.con.Open()

            db.cmd.CommandText = "DELETE * FROM NatAdmin WHERE ExamYear = '" & FrmMain.examYear & "' AND CentNo = '" & selectedCentre(0) & "'"
