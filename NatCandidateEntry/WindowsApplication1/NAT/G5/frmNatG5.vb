...
Public Class frmNatG5
    ...
    Private Sub delCand_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles delCand.Click
        ...
        Try
            ...
            db.cmd.CommandText = "Delete * From NATGRADE5 WHERE ExamYear = '" & connectionHelper.examYear & "' AND CentNo = '" & txtCentNo.Text & "' AND IndexNo = '" & txtIndexNo.Text & "';"
    ...
    Private Sub addCandidate2()
        Try
            ...
            sqlString += "INSERT INTO NATGRADE5 (UpdatedToServer, ExamYear, CentNo, IndexNO, CandName, LastName, FirstName, Initial, Sex, Disability, Dob, Attempts, DateCreated, DateModified, pcName, userName) VALUES " &
                    "(FALSE, '" & examYear & "', '" & txtCentNo.Text & "', '" & txtIndexNo.Text & "', '" & txtCandName.Text & "', '" & txtLastName.Text & "', '" & txtFirstName.Text & "', '" &
                    txtInitial.Text & "', '"
            If cbSex.SelectedIndex = -1 Then
                sqlString += "', '"
    ...
    Function updateCandidateDetails() As Boolean
        ...
        Try
            ...
            db.cmd.CommandText = "SELECT CentNo, IndexNo, LastName, FirstName, Initial, " & _
                "Sex, Disability, Dob, Attempts, UpdatedToServer FROM NATGRADE5 WHERE IndexNo = '" & _
