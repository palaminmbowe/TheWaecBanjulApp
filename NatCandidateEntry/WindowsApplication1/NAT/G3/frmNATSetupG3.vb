...
Public Class frmNATSetupG3
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        If SaveCentreData() Then
            ...
            Me.Close()
        Else
            Dim result As Integer = MessageBox.Show($"There was an error saving your Centre Information. Are you trying to add the same centre twice?{vbNewLine}{vbNewLine}Have you selected a cluster?", "Save Error", MessageBoxButtons.RetryCancel, MessageBoxIcon.Error)
    ...
    Function SaveCentreData() As Boolean
        ...
        Try
            ...
            If clusterComboBox.SelectedIndex = -1 Then
                Return False
            End If

            'clusterId = clusterComboBox.Text.Substring(0, 4)
            clusterId = clusterComboBox.Text.Substring(clusterComboBox.Text.Length - 4, 4)
            ...
            sqlString(1) = "INSERT INTO NatAdminG3 (ExamYear, CentNo, CentName, Location, Owner, SchoolListed, ContactName, ContactPhoneNumber, ClusterID) VALUES ('" & connectionHelper.examYear & "', '" &
            ...
            sqlString(1) += $",'{txtContactName.Text}', '{txtContactPhoneNumber.Text}', {clusterId});"
    ...
    Function checkForFields() As Boolean
        ...
        If clusterComboBox.SelectedIndex = -1 Or clusterComboBox.Text = "" Then
            clusterComboBox.DroppedDown = True
            Return False
        End If

        If txtContactName.Text = "" Then
            txtContactName.BackColor = Color.PaleVioletRed
            txtContactName.Focus()
            Return False
        Else
            txtContactName.BackColor = Color.LightGreen
        End If

        If txtContactPhoneNumber.Text = "" Then
            txtContactPhoneNumber.BackColor = Color.PaleVioletRed
            txtContactPhoneNumber.Focus()
            Return False
        Else
            txtContactPhoneNumber.BackColor = Color.LightGreen
        End If
    ...
    Private Sub txtCentNo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim i As Integer = 0
    ...
    Private Sub clusterComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles clusterComboBox.SelectedIndexChanged
        CheckBoxConfirm.Checked = False
    End Sub

    Private Sub clusterComboBox_TextChanged(sender As Object, e As EventArgs) Handles clusterComboBox.TextChanged
        CheckBoxConfirm.Checked = False
    End Sub

    Private Sub ResetBackgroundColour(sender As Object, e As EventArgs) Handles txtContactName.TextChanged, txtContactPhoneNumber.TextChanged, txtCentNo.TextChanged, txtCentName.TextChanged, txtCentAddress.TextChanged
    ...
    Private Sub txtCentName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        checkForFields()
        txtCentName.Focus()

    End Sub

    Private Sub txtCentAddress_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        checkForFields()
        txtCentAddress.Focus()
    End Sub
