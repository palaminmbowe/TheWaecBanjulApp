...
{
    public partial class frmObjScanning2 : Form
    {
        dbConnection3 db;
        ...
        private bool LoadUserTotalScanned()
        {
            try
            {
                ...
                // add table/query to fetch total
            ...
            try
            {
                ...
                foreach (string s in data)
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            string tableName = String.Concat("Centre", centNo[0]);
                            bool centreOk = false;
                        ...
                        try
                        {
                            string tableName = String.Concat("SubjIndex", centNo[0]);
                        ...
                        try
                        {
                            scanData = s.Substring(absentStartsAt + 2).Trim();
                        ...
                        case scanners.Drs:
                            ...
                            try
                            {
                                db.cmd.CommandText = "INSERT INTO obj_" + currentExam + " " +
                                    "(examYear, centNo, indexNo, CsdSubjCode, Sex, Absent, Data, userName, pcName) VALUES " +
                                    "('" + currentYear + "', '" + centNo + "', '" +
        ...
        private bool LoadScanned()
        {
            ...
            if (this.cbExams.SelectedIndex != -1)
            {
                ...
                try
                {
                    tableName = "obj_" + this.currentGrade;
        ...
        {
            //Orig
            //DataTable dt = ds.Tables["SubjIndex" + cbExams.SelectedItem.ToString().Substring(0, 1)];

            //foreach (DataRow dr in dt.Rows)
            //{
            //    if (CsdSubjCode == dr["CsdSubjCode"].ToString())
            //    {
            ...
            //return "";
            //DataTable table = this.ds.Tables["SubjIndex" + this.cbExams.SelectedItem.ToString().Substring(0, 1)];
            DataTable table = this.ds.Tables["SubjIndex" + this.currentGrade];
            foreach (DataRow row in table.Rows)
            {
        ...
        private bool ScoreSubject(List<string> subjects, bool scoreMissing)
        {
            ...
            try
            {
                ...
                foreach (string subject in subjects)
                {
                    ...
                    string examInitial = this.cbScoreExamType.SelectedItem.ToString().Substring(0, 1);
