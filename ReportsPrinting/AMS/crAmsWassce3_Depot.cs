...
namespace ReportsPrinting.AMS {
    ...
    public class crAmsWassce3_Depot : ReportClass {
        
        public crAmsWassce3_Depot() {
        }
        
        public override string ResourceName {
            get {
                return "crAmsWassce3_Depot.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "ReportsPrinting.AMS.crAmsWassce3_Depot.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedcrAmsWassce3_Depot : Component, ICachedReport {
        
        public CachedcrAmsWassce3_Depot() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            crAmsWassce3_Depot rpt = new crAmsWassce3_Depot();
            rpt.Site = this.Site;
            return rpt;
        }
